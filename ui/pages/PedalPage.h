...
private:
    ...
    void setupKnob(juce::Slider& slider, const juce::String& name,double min, double max, double step);
    ...
    juce::ToggleButton routeMain { "MAIN" };
    juce::ToggleButton routeClean { "CLEAN" };
    juce::ToggleButton routeSub { "SUB" };
    ...
    juce::Slider drive, tone, level, blend, aux1, aux2, aux3;
};
